...
const [currState, setCurrState] = React.useState('Sign up');
  ...
  const onSubmitHandler = (event)=>{
    ...
    // console.log("Password value before login: ", password); 
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <h2 className='font-medium text-2xl flex justify-between items-center'>
       ...
       <button type='submit' className='bg-gradient-to-r from-purple-400 to-violet-600 text-white py-2 px-4 rounded-md hover:opacity-90 transition-opacity duration-300'>
